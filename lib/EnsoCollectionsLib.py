...
#                    'metric_computation': 'difference',
        ...
        'EVAL_IPSL': {
            ...
            'common_collection_parameters': {
                ...
                'modeled_period': ('1850-01-01 00:00:00', '2018-12-31 23:59:60.0'),
            },
            'plot_groupings': {
                'plot_ratio': ['EnsoAmpl', 'EnsoSeasonality', 'EnsoSstSkew', 'NinoSstDiversity'],
                'plot_rmse': ['EnsoSstLonRmse', 'EnsoSstTsRmse'],
            },
            'description': 'Describe which science question this collection is about',
        },
        'ENSO_perf': {
        ...
        'ENSO_tel': {
            ...
            'plot_groupings': {
                ...
                'plot_corr': ['EnsoPrMapCorr', 'EnsoSlpMapCorr', 'EnsoSstMapCorr',
                              'NinaPrMap_1Corr', 'NinaPrMap_2Corr', 'NinaSlpMap_1Corr', 'NinaSlpMap_2Corr',
                              'NinaSstMap_1Corr', 'NinaSstMap_2Corr', 'NinoPrMap_1Corr', 'NinoPrMap_2Corr',
                              'NinoSlpMap_1Corr', 'NinoSlpMap_2Corr', 'NinoSstMap_1Corr', 'NinoSstMap_2Corr'],
                'plot_ratio': ['EnsoAmpl', 'EnsoPrMapStd', 'EnsoSlpMapStd', 'EnsoSstMapStd',
                               'NinaPrMap_1Std', 'NinaPrMap_2Std', 'NinaSlpMap_1Std', 'NinaSlpMap_2Std',
                               'NinaSstMap_1Std', 'NinaSstMap_2Std', 'NinoPrMap_1Std', 'NinoPrMap_2Std',
                               'NinoSlpMap_1Std', 'NinoSlpMap_2Std', 'NinoSstMap_1Std', 'NinoSstMap_2Std'],
                'plot_rmse': ['EnsoPrMapRmse', 'EnsoSlpMapRmse', 'EnsoSstMapRmse',
                              'NinaPrMap_1Rmse', 'NinaPrMap_2Rmse', 'NinaSlpMap_1Rmse', 'NinaSlpMap_2Rmse',
                              'NinaSstLonRmse_1', 'NinaSstLonRmse_2', 'NinaSstMap_1Rmse', 'NinaSstMap_2Rmse',
                              'NinoPrMap_1Rmse', 'NinoPrMap_2Rmse', 'NinoSlpMap_1Rmse', 'NinoSlpMap_2Rmse',
                              'NinoSstLonRmse_1', 'NinoSstLonRmse_2', 'NinoSstMap_1Rmse', 'NinoSstMap_2Rmse'],
            },
            'description': 'Describe which science question this collection is about',
        },
        'ENSO_proc': {
