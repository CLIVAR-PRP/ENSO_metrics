...
def defCollection(mc=True):
    ...
    metrics_collection = {
        ...
        "all_metrics": {
            ...
            "common_collection_parameters": {
                "detrending": {"method": "linear"},
                # "event_definition": {"region_ev": "nino3.4", "season_ev": "DEC", "threshold": 0.5,
                #                      "normalization": True, "smoothing": {"window": 5, "method": "triangle"},
                #                      "duration_min": False},
                "event_definition": {"region_ev": "nino3.4", "season_ev": "NDJ", "threshold": 0.5,
                                     "normalization": True, "smoothing": False,
                                     "duration_min": 5},
                "frequency": "monthly",
                "min_time_steps": 12,
                "normalization": False,
                "project_interpreter": "CMIP",
                # "observed_period": ("1950-01-01 00:00:00", "2019-12-31 23:59:60.0"),
                "observed_period": None,
                "modeled_period": None,
            },
            "plot_order": ["BiasPrLatRmse", "BiasPrLonRmse", "BiasSstLonRmse", "BiasTauxLonRmse",
