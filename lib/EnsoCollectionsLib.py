...
def defCollection(mc=True):
    ...
    metrics_collection = {
        ...
        'ENSO_tel': {
            ...
            'plot_order': ['EnsoSstLonRmse', 'EnsoAmpl', 'EnsoPrMapDjfCorr', 'EnsoPrMapDjfRmse', 'EnsoPrMapJjaCorr',
                           'EnsoPrMapJjaRmse', 'EnsoSstMapDjfCorr', 'EnsoSstMapDjfRmse', 'EnsoSstMapJjaCorr',
                           'EnsoSstMapJjaRmse'],
            'description': 'Describe which science question this collection is about',
        },
        'ENSO_proc': {
