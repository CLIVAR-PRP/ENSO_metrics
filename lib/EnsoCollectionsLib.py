...
def defCollection(metric_collection=True):
    ...
    dict_metric_collections = {
        ...
        "ENSO_eq_stats2": {
            ...
            "plot_order": [
                "nstar_pr_nino3", "nstar_ts_nino3", "nstar_ts_nino3.4", "stat_box_ave_pr_global",
                "stat_box_ave_pr_grad_i", "stat_box_ave_pr_itcz_ne", "stat_box_ave_pr_itcz_se",
                "stat_box_ave_ts_global", "stat_box_ave_ts_grad_x", "stat_box_ave_ts_grad_y"],
            "description": "understanding the low frequency modulation of ENSO variance",
        },
        "ENSO_eq_stats3": {
            "long_name": "Metrics Collection for ENSO internal variability",
