...
#                    'metric_computation': 'difference',
        ...
        'ENSO_perf': {
            ...
            'plot_groupings': {
                'plot_ratio': ['EnsoAmpl', 'EnsoSeasonality'],
...
def ReferenceRegions(AR=True):
    dict_reference_regions = {
        ...
        'equatorial_pacific_LatExt': {
            'long_name': 'Equatorial Pacific extended in latitude', 'latitude': (-15., 15.), 'longitude': (160., 270.),
        },
        'equatorial_pacific_LonRed': {
            'long_name': 'Equatorial Pacific extended in latitude', 'latitude': (-5., 5.), 'longitude': (160., 270.),
        },
