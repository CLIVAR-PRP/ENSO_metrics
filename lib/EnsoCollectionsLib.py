...
#                },
                'EnsoFbSstLhf': {
                    ...
                    'obs_name': {'sst': ['HadISST', 'Tropflux'], 'lhf': ['Tropflux']},
#                    'metric_computation': 'difference',
                },
                'EnsoFbSstLwr': {
                    'variables': ['sst', 'lwr'],
...
#                    'metric_computation': 'difference',
        ...
        'ENSO_proc': {
            ...
            'metrics_list': {
                ...
                'EnsoFbSstLhf': {
                    'variables': ['sst', 'lhf'],
                    'regions': {'sst': 'nino3', 'lhf': 'nino3'},
                    'obs_name': {'sst': ['ERA-Interim', 'Tropflux'], 'lhf': ['ERA-Interim', 'Tropflux']},
                    'regridding': {'regridder': 'cdms', 'regridTool': 'esmf', 'regridMethod': 'linear',
                                   'newgrid_name': 'generic_1x1deg'},
                    'metric_computation': 'ratio',
                },
                ...
                'EnsoFbSstShf': {
                    'variables': ['sst', 'shf'],
                    'regions': {'sst': 'nino3', 'shf': 'nino3'},
                    'obs_name': {'sst': ['ERA-Interim', 'Tropflux'], 'shf': ['ERA-Interim', 'Tropflux']},
                    'regridding': {'regridder': 'cdms', 'regridTool': 'esmf', 'regridMethod': 'linear',
                                   'newgrid_name': 'generic_1x1deg'},
                    'metric_computation': 'ratio',
                },
        ...
        'ENSO_test': {
            'long_name': 'Metrics Collection for all ENSO metrics',
            'metrics_list': {
                # bias
                'BiasPrLatRmse': {
                    'variables': ['pr'],
        ...
        'test_duration': {
            ...
            'common_collection_parameters': {
                ...
                'project_interpreter': 'CMIP',
                'observed_period': ('1850-01-01 00:00:00', '2018-12-31 23:59:60.0'),
                # ('1905-01-01 00:00:00', '2005-12-31 23:59:60.0'),
                'modeled_period': ('1850-01-01 00:00:00', '2015-12-31 23:59:60.0'),
            },
            'description': 'Describe which science question this collection is about',
        },
...
def ReferenceObservations(DATASET=True):
    dict_ref_obs = {
        'AVISO': {
            'source': 'see https://www.aviso.altimetry.fr/en/data/products/sea-surface-height-products/global.html',  # do not use 'source' keyword
        ...
        'Tropflux': {
            'source': 'see https://incois.gov.in/tropflux/tf_products.jsp',
