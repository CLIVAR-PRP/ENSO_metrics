...
def defCollection(metric_collection=True):
    ...
    dict_metric_collections = {
        ...
        "ENSO_eq_stats2": {
            ...
            "metrics_list": {
                ...
                "enso_wait_time_ave": {
                    ...
                    "enso_definition": {"duration_min": 5, "interannual_anomalies": True, "normalization": True,
                                        "region_ev": "nino3.4", "season_ev": "NDJ", "smoothing": False,
                                        "threshold": 0.5},
                    "wait_definition": {"detect": "en_to_en", "method": "peaks",
                                        "smoothing": {"method": "triangle", "window": 5}},
                    "statistic": "average",
                },
                "enso_wait_time_std": {
                    "variables": ["ts"],
            ...
            "plot_order": ["dcorr_ts_nino3.4", "enso_wait_time_ave", "enso_wait_time_std", "nstar_pr_nino3",
                           "nstar_ts_nino3", "nstar_ts_nino3.4", "stat_box_ave_pr_grad_i", "stat_box_ave_pr_itcz_ne",
                           "stat_box_ave_pr_itcz_se", "stat_box_ave_ts_global", "stat_box_ave_ts_grad_x",
                           "stat_box_ave_ts_grad_y"],
            "description": "understanding the low frequency modulation of ENSO variance",
        },
        "ENSO_eq_stats3": {
            ...
            "metrics_list": {
                ...
                "enso_wait_time_ave_1": {
                    ...
                    "internal_variable_name": "ts",
                    "enso_definition": {
                        "region_ev": "nino3.4", "season_ev": "NDJ", "threshold": 0.5, "interannual_anomalies": True,
                        "normalization": True, "smoothing": False, "duration_min": 5},
                    "enso_wait_time_method": "simple",
                    "statistic": "average",
                },
                "enso_wait_time_ave_2": {
                    "variables": ["ts"],
                    "regions": {"ts": "nino3.4"},
                    "obs_name": {"ts": ["ERA-Interim", "HadISST", "Tropflux"]},
                    "metric_computation": "abs_relative_difference",
                    ...
                    "enso_definition": {
                        "region_ev": "nino3.4", "season_ev": "NDJ", "threshold": 0.5, "interannual_anomalies": True,
                        "normalization": True, "smoothing": False, "duration_min": 5},
                    "enso_wait_time_method": "accurate",
                    "statistic": "average",
                },
                "enso_wait_time_std_1": {
                    "variables": ["ts"],
                    "regions": {"ts": "nino3.4"},
                    "obs_name": {"ts": ["ERA-Interim", "HadISST", "Tropflux"]},
                    "metric_computation": "abs_relative_difference",
            ...
            "plot_order": ["dcorr_ts_nino3.4", "enso_wait_time_1", "enso_wait_time_2"],
            "description": "understanding the low frequency modulation of ENSO variance",
        },
        "ENSO_perf": {
            ...
            "metrics_list": {
                ...
                "EnsoDuration": {
                    ...
                    "regions": {"sst": "nino3.4"},
                    "obs_name": {"sst": ["ERA-Interim", "HadISST", "Tropflux"]},
                    "enso_definition": {"region_ev": "nino3.4", "season_ev": "DEC", "threshold": 0.75,
        ...
        "all_metrics": {
            ...
            "common_collection_parameters": {
                "detrending": {"method": "linear"},
                "enso_definition": {"region_ev": "nino3.4", "season_ev": "NDJ", "threshold": 0.5,
                                     "normalization": True, "smoothing": False, "duration_min": 5},
                "frequency": "monthly",
                "min_time_steps": 12,
                "normalization": False,
