...
sst_only = [
    "AVISO", "C-GLORSv5", "C-GLORSv7", "CSIRO_SSH", "COBE", "COBE1", "COBE-1", "COBEv1", "COBE2", "COBE-2", "COBEv2",
    "ERSST3b", "ERSST3.b", "ERSST-3b", "ERSST-3.b", "ERSST-3-b", "ERSSTv3b", "ERSST4", "ERSST-4", "ERSSTv4", "ERSST5",
    "ERSST-5", "ERSSTv5", "GFDL-ECDA3.1", "GFDL-ECDA3-1", "GFDL-ECDA-3.1", "GFDL-ECDA-3-1", "GFDL-ECDAv3.1",
    "GFDL-ECDAv3-1", "GODAS", "HadISST", "HadISST1", "HadISST-1", "HadISSTv1", "HadISST1.1", "HadISST1-1",
    "HadISST-1.1", "HadISST-1-1", "HadISSTv1.1", "HadISSTv1-1", "ISCCP", "ISCCP1", "ISCCP-1", "ISCCPv1", "ISCCP1.0",
    "ISCCP1-0", "ISCCP-1.0", "ISCCP-1-0", "ISCCPv1.0", "ISCCPv1-0", "JPL_MEASURES", "JPL_MEASURES-2205",
    "JPL_MEASURESv2205", "OAFlux", "OAFlux1", "OAFlux-1", "OAFluxv1", "OAFlux1.0", "OAFlux1-0", "OAFlux-1.0",
    "OAFlux-1-0", "OAFluxv1.0", "OAFluxv1-0", "OAFLUX", "OAFLUX1", "OAFLUX-1", "OAFLUXv1", "OAFLUX1.0", "OAFLUX1-0",
    "OAFLUX-1.0", "OAFLUX-1-0", "OAFLUXv1.0", "OAFLUXv1-0", "OAFlux-ISCCP", "OAFlux1-ISCCP1", "OAFlux-1-ISCCP-1",
    "OAFluxv1-ISCCPv1", "OAFlux1.0-ISCCP1.0", "OAFlux1-0-ISCCP1-0", "OAFlux-1.0-ISCCP-1.0", "OAFlux-1-0-ISCCP-1-0",
    "OAFluxv1.0-ISCCPv1.0", "OAFluxv1-0-ISCCPv1-0", "OAFLUX-ISCCP", "OAFLUX1-ISCCP1", "OAFLUX-1-ISCCP-1",
    "OAFLUXv1-ISCCPv1", "OAFLUX1.0-ISCCP1.0", "OAFLUX1-0-ISCCP1-0", "OAFLUX-1.0-ISCCP-1.0", "OAFLUX-1-0-ISCCP-1-0",
    "OAFLUXv1.0-ISCCPv1.0", "OAFLUXv1-0-ISCCPv1-0", "ORAS4", "ORAS-4", "ORASv4", "ORAS5", "ORAS-5", "ORASv5",
    "SODA2.2.4", "SODA2-2-4", "SODA-2.2.4", "SODA-2-2-4", "SODAv2.2.4", "SODAv2-2-4", "SODA3.3.2", "SODA3-3-2",
    "SODA-3.3.2", "SODA-3-3-2", "SODAv3.3.2", "SODAv3-3-2", "SODA3.03.2", "SODA3-03-2", "SODA-3.03.2", "SODA-3-03-2",
    "SODAv3.03.2", "SODAv3-03-2", "SODA3.4.2", "SODA3-4-2", "SODA-3.4.2", "SODA-3-4-2", "SODAv3.4.2", "SODAv3-4-2",
    "SODA3.04.2", "SODA3-04-2", "SODA-3.04.2", "SODA-3-04-2", "SODAv3.04.2", "SODAv3-04-2", "SODA3.11.2", "SODA3-11-2",
    "SODA-3.11.2", "SODA-3-11-2", "SODAv3.11.2", "SODAv3-11-2", "SODA3.12.2", "SODA3-12-2", "SODA-3.12.2",
    "SODA-3-12-2", "SODAv3.12.2", "SODAv3-12-2", "SODA3.15.2", "SODA3-15-2", "SODA-3.15.2", "SODA-3-15-2",
    "SODAv3.15.2", "SODAv3-15-2", "Tropflux", "Tropflux1", "Tropflux-1", "Tropfluxv1", "Tropflux1.0", "Tropflux1-0",
    "Tropflux-1.0", "Tropflux-1-0", "Tropfluxv1.0", "Tropfluxv1-0", "TropFlux", "TropFlux1", "TropFlux-1", "TropFluxv1",
    "TropFlux1.0", "TropFlux1-0", "TropFlux-1.0", "TropFlux-1-0", "TropFluxv1.0", "TropFluxv1-0"]
                        ...
                        for kk in keys2:
                            ...
                            for ll in keys3:
                                dd1[ll] = {"value": valu["diagnostic"][ll][kk + "__value"],
                                           "value_error": valu["diagnostic"][ll][kk + "__value_error"]}
                            mm2 = dict(
                                (ll, vame["metric"][ll]) for ll in list(vame["metric"].keys()) if "units" not in ll)
