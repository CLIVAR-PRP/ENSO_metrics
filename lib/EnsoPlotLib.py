...
plot_parameters = {
    ...
    'EnsoSstMapDjf': {
        'netcdf_variables': ['reg_sst_over_sst_djf_map__', 'reg_sst_over_sst_djf_map__'],
        'diagnostic': {
            'plot_type': 'map',
            'nbr_panel': 2,
            'colorbar': dict_colorbar['anomalies'],
            ...
            # 'varpattern': 'sst_over_sst_map__',
            'varpattern': 'reg_sst_over_sst_djf_map__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        ...
        'dive_down01': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) DJF', 'reg(ENSO SSTA, SSTA) DJF'],
            'varpattern': 'reg_sst_over_sst_djf_map_africaSE__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down02': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) DJF', 'reg(ENSO SSTA, SSTA) DJF'],
            'varpattern': 'reg_sst_over_sst_djf_map_americaN__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down03': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) DJF', 'reg(ENSO SSTA, SSTA) DJF'],
            'varpattern': 'reg_sst_over_sst_djf_map_americaS__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down04': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) DJF', 'reg(ENSO SSTA, SSTA) DJF'],
            'varpattern': 'reg_sst_over_sst_djf_map_asiaS__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down05': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) DJF', 'reg(ENSO SSTA, SSTA) DJF'],
            'varpattern': 'reg_sst_over_sst_djf_map_oceania__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down06': {
            ...
            'label': dict_label['PRA'],
            "maskland": False,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map__", "sst_nino_djf_map__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        ...
        'dive_down07': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map_africaSE__", "sst_nino_djf_map_africaSE__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down08': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map_americaN__", "sst_nino_djf_map_americaN__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down09': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map_americaS__", "sst_nino_djf_map_americaS__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down10': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map_asiaS__", "sst_nino_djf_map_asiaS__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down11': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA DJF', 'El Nino SSTA DJF'],
            'varpattern': ["sst_nina_djf_map_oceania__", "sst_nino_djf_map_oceania__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
    ...
    'EnsoSstMapJja': {
        'netcdf_variables': ['reg_sst_over_sst_jja_map__', 'reg_sst_over_sst_jja_map__'],
        'diagnostic': {
            'plot_type': 'map',
            'nbr_panel': 2,
            'colorbar': dict_colorbar['anomalies'],
            ...
            # 'varpattern': 'sst_over_sst_map__',
            'varpattern': 'reg_sst_over_sst_jja_map__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        ...
        'dive_down01': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) JJA', 'reg(ENSO SSTA, SSTA) JJA'],
            'varpattern': 'reg_sst_over_sst_jja_map_africaSE__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down02': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) JJA', 'reg(ENSO SSTA, SSTA) JJA'],
            'varpattern': 'reg_sst_over_sst_jja_map_americaN__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down03': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) JJA', 'reg(ENSO SSTA, SSTA) JJA'],
            'varpattern': 'reg_sst_over_sst_jja_map_americaS__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down04': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) JJA', 'reg(ENSO SSTA, SSTA) JJA'],
            'varpattern': 'reg_sst_over_sst_jja_map_asiaS__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down05': {
            ...
            "maskocean": True,
            'title': ['reg(ENSO SSTA, SSTA) JJA', 'reg(ENSO SSTA, SSTA) JJA'],
            'varpattern': 'reg_sst_over_sst_jja_map_oceania__',
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down06': {
            ...
            'label': dict_label['PRA'],
            "maskland": False,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map__", "sst_nino_jja_map__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        ...
        'dive_down07': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map_africaSE__", "sst_nino_jja_map_africaSE__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down08': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map_americaN__", "sst_nino_jja_map_americaN__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down09': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map_americaS__", "sst_nino_jja_map_americaS__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down10': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map_asiaS__", "sst_nino_jja_map_asiaS__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
        'dive_down11': {
            ...
            "maskocean": True,
            'title': ['La Nina SSTA JJA', 'El Nino SSTA JJA'],
            'varpattern': ["sst_nina_jja_map_oceania__", "sst_nino_jja_map_oceania__"],
            'xname': 'longitude',
            'yname': 'latitude',
            'zname': 'regression',
        },
