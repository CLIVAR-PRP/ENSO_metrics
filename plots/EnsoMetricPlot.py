...
def main_plotter(metric_collection, metric, model, experiment, filename_nc, diagnostic_values,
                 diagnostic_units, metric_values, metric_units, path_png='', models2=None, shading=False):
    ...
    if isinstance(model, basestring):
        ...
        pattern = metric_collection + "_" + metric + "_" + experiment + "_" + str(len(model)) + "projects"
    else:
